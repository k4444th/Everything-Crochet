    ...
    var body: some View {
        Button{
            ...
            ZStack {
                ...
                VStack (spacing: 0) {
                    AsyncImage(url: URL(string: project.previewImage)) { phase in
